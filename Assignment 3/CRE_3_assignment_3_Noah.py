...
R_WA = 8.314 / M_WA # Specific heat capacity of water in J/mol-K
R_EG = 8.314 / M_EG # Specific heat capacity of ethylene glycol in J/mol-K
R_EO = 8.314 / M_EO # Specific heat capacity of ethylene oxide in J/mol-K
...
c_p_EO_params = np.array([0.5144, 9.1319, 5.0866, -14.4010, -5.0022, 23.4152]) # Parameters for the specific heat capacity of ethylene oxide as a function of temperature (not used in this code)
...
# Heat capacity of ethylene oxide dependent on temperature
def c_p_EO(T, c_p_EO_params):
    return R_EO * (c_p_EO_params[0] / (1- (T / T_C_EO)) + c_p_EO_params[1] + c_p_EO_params[2] * (1 - (T / T_C_EO)) + c_p_EO_params[3] * (1 - (T / T_C_EO))**2 + c_p_EO_params[4] * (1 - (T / T_C_EO))**3 + c_p_EO_params[5] * (1 - (T / T_C_EO))**4) * 1000
...
ax[0, 0].plot(T_range, c_p_WA(T_range, c_p_WA_params), label='Water')
ax[0, 0].plot(T_range, c_p_EO(T_range, c_p_EO_params), label='Ethylene Oxide')
...
ax[0, 1].plot(T_range, rho_EG(T_range, rho_EG_params), label='Ethylene Glycol')
ax[0, 1].plot(T_range, rho_WA(T_range, rho_WA_params), label='Water')
ax[0, 1].plot(T_range, rho_EO(T_range, rho_EO_params), label='Ethylene Oxide')
